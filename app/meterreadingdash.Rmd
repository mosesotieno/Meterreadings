...
renderText(paste("The sum total of consumption as at  ", max(kplcdata()$date_read, na.rm = T) ,"is",sum(kplcdata()$units_perday, na.rm = T)))

renderText(paste("Expected to pay", sum(kplcdata()$units_perday, na.rm = T) * 18))
...
renderText(paste("The sum total of consumption as at  ", max(kiwascodata()$date_read, na.rm = T) ,"is",sum(kiwascodata()$units_perday, na.rm = T)))
